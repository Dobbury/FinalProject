...
<div style="float:left; width:96%; text-align:center;"> 
	<a href="#none" title="처음페이지" onclick="goPage('0');"><img src="WEB-INF/img/arrow_first.gif" alt="처음페이지"/></a>&nbsp;		
		<%
		if (screenStartPageIndex > 1){
			%>
			<a href="#none" title="이전페이지" onclick="goPage('<%=screenStartPageIndex-1%>');"><img src="WEB-INF/img/arrow_prev.gif" alt="이전페이지"/></a>&nbsp;	
			<%
		}
		...
		if (screenEndPageIndex < totalPageCount){
		    %>	
			<a href="#none" title="다음페이지" onclick="goPage(<%=screenEndPageIndex %>);"><img src="WEB-INF/img/arrow_next.gif" alt="다음페이지"/></a>&nbsp;
		    <%
		} // end if
	...
	<a href="#none" title="마지막페이지" onclick="goPage(<%=end_page %>);" ><img src="WEB-INF/img/arrow_end.gif" alt="마지막페이지"/></a>
</div>		
