    ...
    <div class="row">
    	<div class="span9">
        	...
        	<!-- <form id="contact-form" class="contact-form" method="post" action="castSchedule.do"> -->
				...
				<p class="contact-performdate">
                	<input id="contact_perform_date" type="date" placeholder="공연날짜" value="" name="perform_date"/>
                </p>
        ...
        <div class="span3">
        	<div class="contact-details">
				...
				<span id="ch1" style="width: 78%" class="wpcf7-list-item first"><input id="Check1" type="checkbox" name="agegrade" value="중,고등학생"><span class="wpcf7-list-item-label">중,고등학생</span></span>
				<span id="ch2" style="width: 78%" class="wpcf7-list-item first"><input id="Check2" type="checkbox" name="agegrade" value="대학생"><span class="wpcf7-list-item-label">대학생</span></span>
				<span id="ch3" style="width: 78%" class="wpcf7-list-item first"><input id="Check3" type="checkbox" name="agegrade" value="성인남녀"><span class="wpcf7-list-item-label">성인남녀</span></span>
				<br>
				<span id="ch4" style="width: 78%" class="wpcf7-list-item first"><input id="Check4" type="checkbox" name="agegrade" value="고령자"><span class="wpcf7-list-item-label">고령자</span></span>
				<span id="ch5" style="width: 78%" class="wpcf7-list-item first"><input id="Check5" type="checkbox" name="agegrade" value="장애인"><span class="wpcf7-list-item-label">장애인</span></span>
				<span id="ch6" style="width: 78%" class="wpcf7-list-item first"><input id="Check6" type="checkbox" name="agegrade" value="외국인"><span class="wpcf7-list-item-label">외국인</span></span>
				</span>
