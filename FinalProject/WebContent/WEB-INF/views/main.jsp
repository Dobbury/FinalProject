...
<div class="container">
    ...
    <div class="row">
        ...
        <!-- Start Profile -->
    	<div class="span14 profile">
        	<div class="image-wrap">
                <!-- <div class="hover-wrap">
                    <span class="overlay-img"></span>
                    <span class="overlay-text-thumb">CTO/Founder</span>
                </div> -->
                <img src="_include/img/profile/afreeca.jpg" alt="Children">
            </div>
            <h3 class="profile-name">뻐스킹</h3>
            <p class="profile-description"><h4>사랑을 나누면 희망은 덤입니다</h4>저희 뻐스킹에서는 공연행사관람을 통해 세상에 선행을 할 수 있습니다.
            	국내의 실력파 보컬들의 공연을 즐기기만 하시면 됩니다. 뻐스킹은 회원님들의 행사 티켓 구매금액의 50%를 장애아동단체에 기부합니다.</p>
